...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants_DefaultShortcutConstants__ = __webpack_require__(2094);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__stores_get_store__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__constants_RequesterTabConstants__ = __webpack_require__(200);
...
var WorkspaceViewModeService = {

  /**
                                  * used to switch viewMode to build mode for a particular workspaceSession
                                  *
                                  * @returns {Promise}
                                  */
  openBuildMode() {
    let setViewModeEvent = Object(__WEBPACK_IMPORTED_MODULE_1__modules_model_event__["a" /* createEvent */])(
    'setViewMode',
    'workspacesession',
    {
      workspaceSession: { id: Object(__WEBPACK_IMPORTED_MODULE_0__stores_get_store__["a" /* getStore */])('ActiveWorkspaceSessionStore').id },
      viewMode: __WEBPACK_IMPORTED_MODULE_3__constants_RequesterTabConstants__["b" /* WORKSPACE_BUILDER_VIEW */] });



    return Object(__WEBPACK_IMPORTED_MODULE_2__modules_pipelines_user_action__["a" /* default */])(setViewModeEvent);
  },

  /**
      * used to switch viewMode to browse mode for a particular workspaceSession
      *
      * @returns {Promise}
      */
  openBrowseMode() {
    ...
    {
      workspaceSession: { id: Object(__WEBPACK_IMPORTED_MODULE_0__stores_get_store__["a" /* getStore */])('ActiveWorkspaceSessionStore').id },
      viewMode: __WEBPACK_IMPORTED_MODULE_3__constants_RequesterTabConstants__["a" /* WORKSPACE_BROWSER_VIEW */] });
...
/* harmony default export */ __webpack_exports__["a"] = (WorkspaceViewModeService);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ThemeHelpers__ = __webpack_require__(2113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__themes_light_json__ = __webpack_require__(2114);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__themes_dark_json__ = __webpack_require__(2115);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(_) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__controllers_Shortcuts__ = __webpack_require__(990);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__controllers_theme_ThemeManager__ = __webpack_require__(444);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__controllers_theme_ThemeDomDelegator__ = __webpack_require__(2112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ShortcutsList__ = __webpack_require__(1075);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constants_SettingsTypeConstants__ = __webpack_require__(1084);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constants_RequesterTabConstants__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__stores_get_store__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_EditorService__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_WorkspaceViewModeService__ = __webpack_require__(1094);
var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};
...
Shortcuts = class Shortcuts {
  ...
  saveCurrentRequest() {
    let currentEditorId = Object(__WEBPACK_IMPORTED_MODULE_3__stores_get_store__["a" /* getStore */])('ActiveWorkspaceSessionStore').activeEditor;
  ...
  saveCurrentRequestAs() {
    let currentEditorId = Object(__WEBPACK_IMPORTED_MODULE_3__stores_get_store__["a" /* getStore */])('ActiveWorkspaceSessionStore').activeEditor,
    editor = Object(__WEBPACK_IMPORTED_MODULE_3__stores_get_store__["a" /* getStore */])('EditorStore').find(currentEditorId);
  ...
  sendAndDownloadCurrentRequest() {
    let currentEditorId = Object(__WEBPACK_IMPORTED_MODULE_3__stores_get_store__["a" /* getStore */])('ActiveWorkspaceSessionStore').activeEditor,
    editor = currentEditorId && Object(__WEBPACK_IMPORTED_MODULE_3__stores_get_store__["a" /* getStore */])('EditorStore').find(currentEditorId),
